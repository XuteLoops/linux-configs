...
declare -A TASKS=(
    ...
    [kernel]="install_kernel set_preempt_full setup_scx_scheduler check_libahci_sss_quirk"
    [security]="install_apparmor configure_login_delay"
    [audio]="setup_rtkit add_user_to_audio_group configure_pipewire_latency"
    [pacman-config]="configure_pacman_conf install_pacman_contrib setup_paccache_hook install_arch_manwarn setup_pacman_db_backup setup_installed_pkg_list_snapshot"
